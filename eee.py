...
class RobotEnv(gym.Env):
    ...
    def _setupScene(self):
        ...
        self.bucket = pybullet.loadURDF(
            r"D:\projects\graduation project\qi bullet simulation\qi-gym\data\trash.urdf",
        ...
        self.projectile = pybullet.loadURDF(
            r"D:\projects\graduation project\qi bullet simulation\qi-gym\data\ball.urdf",
...
def main():
    ...
    # Train a model
        ...
        if algo == "ppo2":
            ...
            model = DDPG(
                stable_baselines3.ddpg.LnMlpPolicy,
                env,
                verbose=0,
                param_noise=None,
